...
const telegramUrl = (process.env.PORTAL_TELEGRAM_INVITE_URL || 'https://t.me/+cEXIzO199AY5Yjhl').trim();
...
window.PORTAL_CONFIG = {
  ...
  telegramInviteUrl: ${telegramUrl ? JSON.stringify(telegramUrl) : 'null'}
};
`;
